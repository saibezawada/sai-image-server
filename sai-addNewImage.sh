...
git status -s -b
echo
echo "$NEW_IMAGE has been pushed to the cloud and sai-image-server is redeploying."
echo "Once sai-image-server finishes redeploying (~5 minutes), access this new image at:"
